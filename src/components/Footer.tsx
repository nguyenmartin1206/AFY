    ...
    <footer className="bg-bg-base border-t border-border-main pt-24 pb-12 font-sans">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          ...
          {/* Links */}
          <div className="space-y-8">
            <h4 className="text-[11px] font-black text-primary uppercase tracking-[0.3em]">AI Services</h4>
            <ul className="space-y-4 text-sm text-text-secondary">
              <li className="hover:text-accent cursor-pointer transition-all duration-300 font-bold">Model Training</li>
          ...
          {/* Contact - Safety Card */}
          <div className="space-y-8">
            <h4 className="text-[11px] font-black text-primary uppercase tracking-[0.3em]">Security Protocol</h4>
            <div className="p-8 rounded-3xl bg-bg-surface border border-border-main relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-[11px] text-text-secondary leading-relaxed">
                  Every neural deployment is finalized through our multi-signature integrity system.
                </p>
                <div className="mt-6 flex items-center gap-2 text-[10px] font-black text-accent uppercase tracking-widest cursor-pointer group-hover:translate-x-1 transition-transform">
                  View Security <ChevronRight className="w-3 h-3" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-border-main pt-12 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-10 items-center opacity-30 hover:opacity-60 transition-opacity duration-500">
            <img src="https://cdn.svgporn.com/logos/payoneer.svg" alt="Payoneer" className="h-6 dark:invert" referrerPolicy="no-referrer" />
            <img src="https://cdn.svgporn.com/logos/mastercard.svg" alt="Mastercard" className="h-8 dark:invert" />
            <img src="https://cdn.svgporn.com/logos/paypal.svg" alt="PayPal" className="h-6 dark:invert" />
          </div>
        </div>
      </div>
    </footer>
